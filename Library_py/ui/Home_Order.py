...
# Form implementation generated from reading ui file 'C:\Users\yagiz\Desktop\Workspace\Library_Assignment\Library_py\ui\Home_Order.ui'
#
...
"color:rgb(255,255,255);")
        ...
        self.txtOrderUserUIDInsert = QtWidgets.QLineEdit(self.formLayoutWidget)
        ...
        self.txtOrderCatalogUIDInsert = QtWidgets.QLineEdit(self.formLayoutWidget)
        ...
        self.cmbOrderType = QtWidgets.QComboBox(self.formLayoutWidget)
        ...
        self.cmbIsReturned = QtWidgets.QComboBox(self.formLayoutWidget)
        ...
        self.dateEndDateInsert = QtWidgets.QDateTimeEdit(self.formLayoutWidget)
        ...
        self.btnOrderInsert = QtWidgets.QPushButton(self.formLayoutWidget)
        ...
        self.dateStartDateInsert = QtWidgets.QDateTimeEdit(self.formLayoutWidget)
        ...
        self.txtOrderUserUIDEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        ...
        self.txtOrderCatalogUIDEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        ...
        self.cmbOrderTypeEdit = QtWidgets.QComboBox(self.formLayoutWidget_2)
        ...
        self.cmbIsReturnedEdit = QtWidgets.QComboBox(self.formLayoutWidget_2)
        ...
        self.dateEndDateEdit = QtWidgets.QDateTimeEdit(self.formLayoutWidget_2)
        ...
        self.btnOrderEdit = QtWidgets.QPushButton(self.formLayoutWidget_2)
        ...
        self.dateStartDateEdit = QtWidgets.QDateTimeEdit(self.formLayoutWidget_2)
...
"color:rgb(255,255,255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txtOrderUserUIDInsert.setPlaceholderText(_translate("MainWindow", "User Unique Id"))
        self.txtOrderCatalogUIDInsert.setPlaceholderText(_translate("MainWindow", "Catalog Unique Id"))
        self.cmbOrderType.setItemText(0, _translate("MainWindow", "Subscription"))
        self.cmbOrderType.setItemText(1, _translate("MainWindow", "Room"))
        self.cmbIsReturned.setItemText(0, _translate("MainWindow", "Returned"))
        self.cmbIsReturned.setItemText(1, _translate("MainWindow", "Not Returned"))
        self.label_22.setText(_translate("MainWindow", "End Date"))
        self.btnOrderInsert.setText(_translate("MainWindow", "Save"))
        ...
        self.txtOrderUserUIDEdit.setPlaceholderText(_translate("MainWindow", "User Unique Id"))
        self.txtOrderCatalogUIDEdit.setPlaceholderText(_translate("MainWindow", "Catalog Unique Id"))
        self.cmbOrderTypeEdit.setItemText(0, _translate("MainWindow", "Subscription"))
        self.cmbOrderTypeEdit.setItemText(1, _translate("MainWindow", "Room"))
        self.cmbIsReturnedEdit.setItemText(0, _translate("MainWindow", "Returned"))
        self.cmbIsReturnedEdit.setItemText(1, _translate("MainWindow", "Not Returned"))
        self.label_23.setText(_translate("MainWindow", "End Date"))
        self.btnOrderEdit.setText(_translate("MainWindow", "Save"))
        self.label_24.setText(_translate("MainWindow", "Start Date"))
